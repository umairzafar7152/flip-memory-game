...
import kotlinx.android.synthetic.main.fragment_single_player24.*
import com.chumairzafar.flipmemory.R.drawable.*

class SinglePlayerFragment24 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_single_player24, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mPreferences = activity!!.applicationContext.getSharedPreferences(sharedPrefsFile, MODE_PRIVATE)
        ...
        imageViews = arrayOf(img1, img2, img3, img4, img5, img6, img7, img8)
        lastCard = -1
                ...
                if (imageViews[i].contentDescription == "cardBack") {
                    if (lastCard < 0) {
                        ...
                        if (images[i] == images[lastCard]) {
                            ...
                            imageViews[lastCard].contentDescription = imageViews[lastCard].toString()
    ...
    private fun passData(pAttempts: Int, pLevelCompleted: Boolean) {
        dataPasser.onDataPass("frag24", pAttempts, pLevelCompleted)
    }
