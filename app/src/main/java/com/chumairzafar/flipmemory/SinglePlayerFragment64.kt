...
import kotlinx.android.synthetic.main.fragment_single_player64.*
import com.chumairzafar.flipmemory.R.drawable.*

class SinglePlayerFragment64 : Fragment() {

    private var lastCard = -1
    private var attempts = 23
    private var found = 0
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_single_player64, container, false)
    }
