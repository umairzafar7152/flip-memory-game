...
import kotlinx.android.synthetic.main.activity_single_player_selection.*


class SinglePlayerSelectionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myAdapter.onItemClick = {
            ...
            val myIntent = Intent(this, SinglePlayerActivity::class.java)
            val itemSelected = listTitles[it]
            myIntent.putExtra("type", itemSelected)
            startActivity(myIntent)
        }
        val pHighScore = mPreferences.getInt(HIGH_SCORE_KEY, 0).toString()
        highScore.text = pHighScore
    }
