...
import kotlinx.android.synthetic.main.fragment_single_player32.*
import com.chumairzafar.flipmemory.R.drawable.*

class SinglePlayerFragment32 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_single_player32, container, false)
    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        passData(attempts, false)
        mPreferences = activity!!.getSharedPreferences(sharedPrefsFile, MODE_PRIVATE)
        ...
        imageViews = arrayOf(img1, img2, img3, img4, img5, img6)
        lastCard = -1
    ...
    private fun passData(pAttempts: Int, pLevelCompleted: Boolean) {
        dataPasser.onDataPass("frag32", pAttempts, pLevelCompleted)
    }
