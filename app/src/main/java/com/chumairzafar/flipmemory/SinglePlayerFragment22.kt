...
import kotlinx.android.synthetic.main.fragment_single_player22.*
import kotlin.collections.ArrayList

class SinglePlayerFragment22 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_single_player22, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mPreferences =
            activity!!.applicationContext.getSharedPreferences(sharedPrefsFile, MODE_PRIVATE)
        ...
        imageViews = arrayOf(img1, img2, img3, img4)
        lastCard = -1
    ...
    private fun passData(pAttempts: Int, pLevelCompleted: Boolean) {
        dataPasser.onDataPass("frag22", pAttempts, pLevelCompleted)
    }
