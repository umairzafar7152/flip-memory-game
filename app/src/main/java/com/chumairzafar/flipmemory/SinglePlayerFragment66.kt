...
import kotlinx.android.synthetic.main.fragment_single_player66.*
import com.chumairzafar.flipmemory.R.drawable.*

class SinglePlayerFragment66 : Fragment() {
    private var lastCard = -1
    private var attempts = 29
    private var found = 0
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_single_player66, container, false)
    }
