...
import kotlinx.android.synthetic.main.fragment_single_player44.*
import com.chumairzafar.flipmemory.R.drawable.*

class SinglePlayerFragment44 : Fragment() {
    private var lastCard = -1
    private var attempts = 15
    private var found = 0
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_single_player44, container, false)
    }
