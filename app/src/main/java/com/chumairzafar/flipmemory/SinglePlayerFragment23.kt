...
import kotlinx.android.synthetic.main.fragment_single_player23.*

class SinglePlayerFragment23 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_single_player23, container, false)
    }
    ...
    private fun passData(pAttempts: Int, pLevelCompleted: Boolean) {
        dataPasser.onDataPass("frag23", pAttempts, pLevelCompleted)
    }
