...
import kotlinx.android.synthetic.main.fragment_single_player76.*
import com.chumairzafar.flipmemory.R.drawable.*

class SinglePlayerFragment76 : Fragment() {
    private var lastCard = -1
    private var attempts = 36
    private var found = 0
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_single_player76, container, false)
    }
