...
import kotlinx.android.synthetic.main.fragment_single_player34.*
import com.chumairzafar.flipmemory.R.drawable.*

class SinglePlayerFragment34 : Fragment() {

    private var lastCard = -1
    private var attempts = 13
    private var found = 0
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_single_player34, container, false)
    }
    ...
    private fun passData(pAttempts: Int, pLevelCompleted: Boolean) {
        dataPasser.onDataPass("frag34", pAttempts, pLevelCompleted)
    }
